    ...
    render() {
        return (
          <div className="center">
            ...
            <button type="button" className='btn'>Select Image</button>
            </ReactFileReader>
            <button className="btn unselect_style" type="button" onClick={this.cleartheImage}>unselect Image</button>
            <br/>
            <input required type="text" placeholder="about the image..." value={this.state.description} className="uploading_input" onChange={this.onChangedescription}/>
